...
#ifndef PovrayParser_hpp
#define PovrayParser_hpp
...
public:
    ...
    ///
    static std::string trimRight(const std::string & toTrim, const std::string & t) {
    ...
    ///
    static void getObjectBodyAndNewContent(std::string & content, std::string & body) {
